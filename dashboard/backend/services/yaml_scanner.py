...
from ..config import EMBODIMENTS_DIR, PLANNER_TYPES_DIR, ALLOCATOR_TYPES_DIR
        ...
        for yaml_file in subdir.glob("*.yaml"):
            ...
            try:
                ...
                embodiments.append({
                    ...
                    "default_port": config.get("taskServer", {}).get("port", 8000),
                    "config_path": str(yaml_file.relative_to(PROJECT_ROOT)),
