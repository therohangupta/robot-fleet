...
export interface ManualTaskDefinition {
  temp_id: string  // Temporary ID for referencing (e.g., "t1", "t2")
  description: string
  robot_id?: string  // Assigned robot (optional)
  robot_type?: string  // Required capability type (optional)
  depends_on: string[]  // List of temp_ids this task depends on
  goal_id?: number  // Link to a goal (optional)
}
