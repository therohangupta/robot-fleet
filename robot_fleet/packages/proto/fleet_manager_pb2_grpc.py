...
class FleetManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRobot = channel.unary_unary(
                '/robot_fleet.FleetManager/GetRobot',
                request_serializer=fleet__manager__pb2.GetRobotRequest.SerializeToString,
                response_deserializer=fleet__manager__pb2.GetRobotResponse.FromString,
                _registered_method=True)
        ...
        self.UpdateTask = channel.unary_unary(
                '/robot_fleet.FleetManager/UpdateTask',
...
def add_FleetManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetRobot': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRobot,
                    request_deserializer=fleet__manager__pb2.GetRobotRequest.FromString,
                    response_serializer=fleet__manager__pb2.GetRobotResponse.SerializeToString,
            ),
...
class FleetManager(object):
    ...
    def GetRobot(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/robot_fleet.FleetManager/GetRobot',
            fleet__manager__pb2.GetRobotRequest.SerializeToString,
            fleet__manager__pb2.GetRobotResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
