...
from packages.config import DEFAULT_ROBOT_BASE_PORT
...
class TaskDeleteResponse(BaseModel):
    """Task deletion result (dependents are unlinked server-side)."""
...
class EmbodimentResponse(BaseModel):
    ...
    default_port: int = Field(default=DEFAULT_ROBOT_BASE_PORT, description="Default task server port")
