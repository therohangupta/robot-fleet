...
from packages.config import DEFAULT_ROBOT_HOST, DEFAULT_ROBOT_BASE_PORT
...
class RobotInstanceCreate(BaseModel):
    ...
    port: int = Field(
        default=DEFAULT_ROBOT_BASE_PORT,
...
class TaskUpdate(BaseModel):
    ...
    robot_id: Optional[str] = Field(None, description="Assigned robot ID (empty string to clear)")
